...
The read in function of the SCAE package `read_allele_counts()` expects specific files and file identifiers.
...
These identifiers are set as standard values, but can be changed in the corresponding parameters of the `read_allele_counts()` function in case they are different.
